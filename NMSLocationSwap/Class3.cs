...
namespace Nmsjson2
{
    ...
    */
    ...
    public partial class Nms
    {
        public static Nms FromJson(string json) => JsonConvert.DeserializeObject<Nms>(json, Nmsjson2.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Nms self) => JsonConvert.SerializeObject(self, Nmsjson2.Converter.Settings);
    }
